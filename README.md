...
| `AWS_REGION` | The region where you created your bucket. Unset by default. [Full list of regions here.](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-available-regions) | `env` | No | Unset/Automatic |
